...
const int YSGLSL_variColor3DDrawingFragmentShader_nLine=109;
...
const int YSGLSL_variColorPerVtxShading3DDrawingFragmentShader_nLine=109;
...
const int YSGLSL_variColorPerPixShading3DDrawingFragmentShader_nLine=280;
...
const int YSGLSL_variColorBillBoard3DDrawingFragmentShader_nLine=90;
...
const int YSGLSL_flash3DDrawingFragmentShader_nLine=119;
...
const int YSGLSL_flashByPointSprite3DDrawingFragmentShader_nLine=120;
...
const int YSGLSL_variColorMarker3DDrawingFragmentShader_nLine=176;
...
const int YSGLSL_variColorMarkerByPointSprite3DDrawingFragmentShader_nLine=178;
...
const int YSGLSL_variColorPointSprite3DDrawingFragmentShader_nLine=99;
