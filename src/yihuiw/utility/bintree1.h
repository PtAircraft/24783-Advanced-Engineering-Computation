...
protected:
    ...
    void Rebalance(Node *nodePtr)
    {
        while (nodePtr != nullptr) {
            ...
            if(balance >= 2) {
                int heightLL = GetHeight(MakeHandle(nodePtr->left->left));
                int heightLR = GetHeight(MakeHandle(nodePtr->left->right));
                int balanceL = heightLL - heightLR;
                printf("check Left heavy\n");
...
//                    nodePtr = nodePtr->up;
            ...
            if(balance <= -2) {
                int heightRL = GetHeight(MakeHandle(nodePtr->right->left));
                int heightRR = GetHeight(MakeHandle(nodePtr->right->right));
                int balanceR = heightRL - heightRR;
                printf("check right heavy\n");
                ...
                if (balanceR >= 1) {
                    ...
                    printf("check 1\n");
//                    nodePtr->right = nodePtr->right->up;
                    printf("check 2\n");
                    RotateLeft(MakeHandle(nodePtr));
                    printf("check 3\n");
//                    nodePtr = nodePtr->up;
